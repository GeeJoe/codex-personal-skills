...
Read each stage file from this `godogen` skill directory only when you reach that stage.

When running bundled helper tools from a generated game repo, first resolve this skill directory to an absolute path and use it as `GODOGEN_SKILL_DIR`.
